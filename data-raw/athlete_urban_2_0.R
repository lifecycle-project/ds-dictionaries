...
trimester_rep_v <- readxl::read_xlsx("data-raw/athlete_urban_2_0/1_3_trimester_rep.xlsx", sheet = "Variables")
trimester_rep_c <- readxl::read_xlsx("data-raw/athlete_urban_2_0/1_3_trimester_rep.xlsx", sheet = "Categories")

yearly_rep_v <- readxl::read_xlsx("data-raw/athlete_urban_2_0/1_3_yearly_rep.xlsx", sheet = "Variables")
yearly_rep_c <- readxl::read_xlsx("data-raw/athlete_urban_2_0/1_3_yearly_rep.xlsx", sheet = "Categories")
...
athlete_urban_2_0 <- nest_join(variables, categories, by = "name")
...
#
# diff <- dplyr::setdiff(athlete_urban_2_1, athlete_urban_2_0)
# NEWS <- diff %>% dplyr::select(name, valueType, label)
#
# write_lines(c("\n"), "NEWS.md", append = TRUE)
# write_lines("## Release: athlete_urban_2_1", "NEWS.md", append = TRUE)
# write_lines(c("\n"), "NEWS.md", append = TRUE)
# write_lines("### Usage\n", "NEWS.md", append = TRUE)
# write_lines(c("``` r\nlibrary(dsDictionaries)\ndata(athlete_urban_2_1)\n```\n"), "NEWS.md", append = TRUE)
# write_lines("### Changes\n", "NEWS.md", append = TRUE)
# write_lines(
#   knitr::kable(NEWS, caption = "athlete_urban_2_1 changes"),
#   "NEWS.md",
#   append = TRUE, )
# Edit the NEWS.md file by hand to make sure it is formatted correctly

usethis::use_data(athlete_urban_2_0, overwrite = TRUE)
