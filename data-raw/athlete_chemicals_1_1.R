library(readxl)
library(tidyverse)
# Copy over the original dictionary from dictionaries/chemicals_ath/1_1 to data-raw and rename folder to athlete_chemicals_1_1
non_rep_v <- readxl::read_xlsx("data-raw/athlete_chemicals_1_1/1_1_non_rep.xlsx", sheet = "Variables")
non_rep_c <- readxl::read_xlsx("data-raw/athlete_chemicals_1_1/1_1_non_rep.xlsx", sheet = "Categories")

trimester_rep_v <- readxl::read_xlsx("data-raw/athlete_chemicals_1_1/1_1_trimester_rep.xlsx", sheet = "Variables")

yearly_rep_v <- readxl::read_xlsx("data-raw/athlete_chemicals_1_1/1_1_yearly_rep.xlsx", sheet = "Variables")
...
athlete_chemicals_1_1 <- nest_join(variables, categories, by = "name")
...
usethis::use_data(athlete_chemicals_1_1, overwrite = TRUE)
