...
monthly_rep_v <- readxl::read_xlsx("data-raw/athlete_outcome_2_0/1_3_monthly_rep.xlsx", sheet = "Variables")

trimester_rep_v <- readxl::read_xlsx("data-raw/athlete_outcome_2_0/1_3_trimester_rep.xlsx", sheet = "Variables")

yearly_rep_v <- readxl::read_xlsx("data-raw/athlete_outcome_2_0/1_3_yearly_rep.xlsx", sheet = "Variables")
yearly_rep_c <- readxl::read_xlsx("data-raw/athlete_outcome_2_0/1_3_yearly_rep.xlsx", sheet = "Categories")
...
#
# diff <- dplyr::setdiff(athlete_outcome_2_1, athlete_outcome_2_0)
# NEWS <- diff %>% dplyr::select(name, valueType, label)
#
# write_lines(c("\n"), "NEWS.md", append = TRUE)
# write_lines("## Release: athlete_outcome_2_0", "NEWS.md", append = TRUE)
# write_lines(c("\n"), "NEWS.md", append = TRUE)
# write_lines("### Usage\n", "NEWS.md", append = TRUE)
# write_lines(c("``` r\nlibrary(dsDictionaries)\ndata(athlete_outcome_2_0)\n```\n"), "NEWS.md", append = TRUE)
# write_lines("### Changes\n", "NEWS.md", append = TRUE)
# write_lines(
#   knitr::kable(NEWS, caption = "athlete_outcome_2_0 changes"),
#   "NEWS.md",
#   append = TRUE, )
# Edit the NEWS.md file by hand to make sure it is formatted correctly

usethis::use_data(athlete_outcome_2_0, overwrite = TRUE)
