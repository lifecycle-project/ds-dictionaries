library(readxl)
library(tidyverse)
# Copy over the original dictionary from dictionaries/core/2_6 to data-raw and rename folder to lifecycle_core_2_6
non_rep_v <- readxl::read_xlsx("data-raw/lifecycle_core_2_6/2_6_non_rep.xlsx", sheet = "Variables")
non_rep_c <- readxl::read_xlsx("data-raw/lifecycle_core_2_6/2_6_non_rep.xlsx", sheet = "Categories")

monthly_rep_v <- readxl::read_xlsx("data-raw/lifecycle_core_2_6/2_6_monthly_rep.xlsx", sheet = "Variables")

trimester_rep_v <- readxl::read_xlsx("data-raw/lifecycle_core_2_6/2_6_trimester_rep.xlsx", sheet = "Variables")
trimester_rep_c <- readxl::read_xlsx("data-raw/lifecycle_core_2_6/2_6_trimester_rep.xlsx", sheet = "Categories")

yearly_rep_v <- readxl::read_xlsx("data-raw/lifecycle_core_2_6/2_6_yearly_rep.xlsx", sheet = "Variables")
yearly_rep_c <- readxl::read_xlsx("data-raw/lifecycle_core_2_6/2_6_yearly_rep.xlsx", sheet = "Categories")
