library(readxl)
library(tidyverse)
dictionary_kind = "core"
# Copy over the original dictionary from dictionaries/core/2_6 to data-raw and rename folder to lifecycle_core_3_0
non_rep_v <- readxl::read_xlsx("data-raw/lifecycle_core_3_0/2_6_non_rep.xlsx", sheet = "Variables")
non_rep_c <- readxl::read_xlsx("data-raw/lifecycle_core_3_0/2_6_non_rep.xlsx", sheet = "Categories")

monthly_rep_v <- readxl::read_xlsx("data-raw/lifecycle_core_3_0/2_6_monthly_rep.xlsx", sheet = "Variables")

trimester_rep_v <- readxl::read_xlsx("data-raw/lifecycle_core_3_0/2_6_trimester_rep.xlsx", sheet = "Variables")
trimester_rep_c <- readxl::read_xlsx("data-raw/lifecycle_core_3_0/2_6_trimester_rep.xlsx", sheet = "Categories")

yearly_rep_v <- readxl::read_xlsx("data-raw/lifecycle_core_3_0/2_6_yearly_rep.xlsx", sheet = "Variables")
yearly_rep_c <- readxl::read_xlsx("data-raw/lifecycle_core_3_0/2_6_yearly_rep.xlsx", sheet = "Categories")
...
lifecycle_core_3_0 <- nest_join(variables, categories, by = "name")
...
#
# diff <- dplyr::setdiff(lifecycle_core_3_1, lifecycle_core_3_0)
# NEWS <- diff %>% dplyr::select(name, valueType, label)
#
# write_lines(c("\n"), "NEWS.md", append = TRUE)
# write_lines("## Release: lifecycle_core_3_1", "NEWS.md", append = TRUE)
# write_lines(c("\n"), "NEWS.md", append = TRUE)
# write_lines("### Usage\n", "NEWS.md", append = TRUE)
# write_lines(c("``` r\nlibrary(dsDictionaries)\ndata(lifecycle_core_3_1)\n```\n"), "NEWS.md", append = TRUE)
# write_lines("### Changes\n", "NEWS.md", append = TRUE)
# write_lines(
#   knitr::kable(NEWS, caption = "lifecycle_core_3_1 changes"),
#   "NEWS.md",
#   append = TRUE, )
# # Edit the NEWS.md file by hand to make sure it is formatted correctly

usethis::use_data(lifecycle_core_3_0, overwrite = TRUE)
