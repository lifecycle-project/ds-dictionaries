...
categories <- tibble::add_column(table = "methyl_cord_blood", categories, .before = "variable")
...
variables <- tibble::add_column(table = "methyl_cord_blood", variables, .before = "name")
