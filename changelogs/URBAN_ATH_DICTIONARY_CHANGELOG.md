# Versions of data dictionaries urban_ath
...
First version of the urban_ath variable set.

#### General changes

Added urban_ath variables defined by Athlete
...
| ath_ndvi100_preg | decimal | average of NDVI values within a buffer of 100 m at pregnancy |
| ath_ndvi300_preg | decimal | average of NDVI values within a buffer of 300 m at pregnancy |
| ath_ndvi500_preg | decimal | average of NDVI values within a buffer of 500 m at pregnancy |
| ath_no2_preg | decimal | no2 average value (extrapolated back in time using ratio method) during pregnancy |
| ath_no2e_preg | decimal | no2e average value (extrapolated back in time using ratio method) during pregnancy |
...
| ath_pm25e_preg | decimal | pm25e average value (extrapolated back in time using ratio method) during pregnancy |
...
| ath_no2_t | decimal | no2 average value (extrapolated back in time using ratio method) during second trimester |
| ath_no2e_t | decimal | no2e average value (extrapolated back in time using ratio method) during second trimester |
| ath_nox_t | decimal | nox average value (extrapolated back in time using ratio method) during second trimester |
| ath_pm10_t | decimal | pm10 average value (extrapolated back in time using ratio method) during second trimester |
| ath_pm25_t | decimal | pm25 average value (extrapolated back in time using ratio method) during second trimester |
| ath_pm25e_t | decimal | pm25e average value (extrapolated back in time using ratio method) during second trimester |
| ath_pmcoarse_t | decimal | pmcoarse average value (extrapolated back in time using ratio method) during second trimester |
| ath_pm25abs_t | decimal | pm25abs average value (extrapolated back in time using ratio method) during second trimester |
| ath_pm25cu_t | decimal | pm25cu value at second trimester |
| ath_pm25fe_t | decimal | pm25fe value at second trimester |
| ath_pm25k_t | decimal | pm25k value at second trimester |
| ath_pm25ni_t | decimal | pm25ni value at second trimester |
| ath_pm25s_t | decimal | pm25s value at second trimester |
| ath_pm25si_t | decimal | pm25si value at second trimester |
| ath_pm25v_t | decimal | pm25v value at second trimester |
| ath_pm25zn_t | decimal | pm25zn value at second trimester |
| ath_pm10cu_t | decimal | pm10cu value at second trimester |
| ath_pm10fe_t | decimal | pm10fe value at second trimester |
| ath_pm10k_t | decimal | pm10k value at second trimester |
| ath_pm10ni_t | decimal | pm10ni value at second trimester |
| ath_pm10s_t | decimal | pm10s value at second trimester |
| ath_pm10si_t | decimal | pm10si value at second trimester |
| ath_pm10v_t | decimal | pm10v value at second trimester |
| ath_pm10zn_t | decimal | pm10zn value at second trimester |
| ath_blue_dist_t | decimal | straight line distance to nearest blue space > 5,000 m2 at  second trimester |
| ath_green_dist_t | decimal | straight line distance to nearest green space > 5,000 m2 at  second trimester |
| ath_blue_size_t | decimal | area of closest blue space > 5,000m2 at second trimester |
| ath_green_size_t | decimal | area of closest green space > 5,000m2 at second trimester |
| ath_blueyn300_t | binary | is there a blue space  > 5,000 m2 in a distance of 300 m? at second trimester |
| ath_greenyn300_t | binary | is there a green space  > 5,000 m2 in a distance of 300 m? at second trimester |
| ath_ndvi100_t | decimal | average of NDVI values within a buffer of 100 m at second trimester |
| ath_ndvi300_t | decimal | average of NDVI values within a buffer of 300 m at second trimester |
| ath_ndvi500_t | decimal | average of NDVI values within a buffer of 500 m at second trimester |
| ath_pntv_t | decimal | average of percent of nontree vegetation within a buffer of 300 m at second trimester |
| ath_pnv_t | decimal | average of percent of non vegetated within a buffer of 300 m at second trimester |
| ath_ptc_t | decimal | average of percent of tree covered within a buffer of 300 m at second trimester |
| ath_popdens_t | decimal | population density at second trimester |
| ath_bdens100_t | decimal | building density within a buffer of 100 m at second trimester |
| ath_bdens300_t | decimal | building density within a buffer of 300 m at second trimester |
| ath_connind100_t | decimal | connectivity density within a buffer of 100 m at second trimester |
| ath_connind300_t | decimal | connectivity density within a buffer of 300 m at second trimester |
| ath_lines_100_t | decimal | length of public transport lines within a buffer of 100 m at second trimester |
| ath_lines_300_t | decimal | length of public transport lines within a buffer of 300 m at second trimester |
| ath_lines_500_t | decimal | length of public transport lines within a buffer of 500 m at second trimester |
| ath_stops_100_t | decimal | number of public transport stops within a buffer of 100 m at second trimester |
| ath_stops_300_t | decimal | number of public transport stops within a buffer of 300 m at second trimester |
| ath_stops_500_t | decimal | number of public transport stops within a buffer of 500 m at second trimester |
| ath_fdensity300_t | decimal | number of facilities present within a buffer of 300 m at second trimester |
| ath_frichness300_t | decimal | number of different facility types present divided by the maximum potential number of facility types within a buffer of 300 m at second trimester |
| ath_landuseshan300_t | decimal | landuse Shannon's Evenness Index within a buffer of 300 m at second trimester |
| ath_walkability_mean_t | decimal | walkability index (as mean of deciles of facility richness index, landuse shannon's Evenness Index, population density, connectivity density) within a buffer of 300 m at second trimester |
| ath_agrgr_t | decimal | percentage of agrgr (agricultural areas, semi-natural areas and wetlands) land use within a buffer of 300 m at second trimester |
| ath_airpt_t | decimal | percentage of airpt (airports) land use within a buffer of 300 m at second trimester |
| ath_hdres_t | decimal | percentage of hdres (continuous urban fabric) land use within a buffer of 300 m at second trimester |
| ath_indtr_t | decimal | percentage of indtr (industrial, commercial, public, military and private units) land use within a buffer of 300 m at second trimester |
| ath_ldres_t | decimal | percentage of ldres (discontinuous dense/medium density/low density urban fabric) land use within a buffer of 300 m at second trimester |
| ath_natgr_t | decimal | percentage of natgr (forests) land use within a buffer of 300 m at second trimester |
| ath_other_t | decimal | percentage of other (mineral extraction and dump sites, construction sites, land without current use) land use within a buffer of 300 m at second trimester |
| ath_port_t | decimal | percentage of port (port areas) land use within a buffer of 300 m at second trimester |
| ath_trans_t | decimal | percentage of trans (road and rail network and associated land, fast transit roads and associated land, other roads and associated land, railways and associated land) land use within a buffer of 300 m at second trimester |
| ath_urbgr_t | decimal | percentage of urbgr (green urban areas, sports and leisure facilities) land use within a buffer of 300 m at second trimester |
| ath_vldres_t | decimal | percentage of vldres (discontinuous very low density urban fabric) land use within a buffer of 300 m at second trimester |
| ath_water_t | decimal | percentage of water land use within a buffer of 300 m at second trimester |
| ath_areases_tert_t | integer | area-level SES indicator (deprivation index in tertiles) at second trimester |
| ath_areases_quint_t | integer | area-level SES indicator (deprivation index in quintiles) at second trimester |
| ath_distinvnear1_t | decimal | inverse distance to nearest road at second trimester |
| ath_trafload100_t | decimal | total traffic load of all roads within a buffer of 100 m at second trimester |
| ath_trafmajorload100_t | decimal | total traffic load of major roads within a buffer of 100 m at second trimester |
| ath_trafnear_t | decimal | traffic density on nearest road at second trimester |
| ath_lden_t | decimal | day-evening-night level at second trimester |
| ath_ln_t | decimal | night level at second trimester |
| ath_lden_c_t | integer | categorized day-evening-night level at second trimester |
| ath_ln_c_t | integer | categorized night level at second trimester |
| ath_noise_dist_t | decimal | straight distance to the nearest road with noise level at second trimester |
| ath_foodenvdens300_t | decimal | number of facilities related to unhealthy food divided by the area of the 300 meters buffer at second trimester |
| ath_tm_t | decimal | average of mean temperature during second trimester |
| ath_tmin_t | decimal | average of minimum temperature during second trimester |
| ath_tmax_t | decimal | average of maximum temperature during second trimester |
| ath_hum_t | decimal | average of mean relative humidity during second trimester |
| ath_hmin_t | decimal | average of minimum relative humidity during second trimester |
| ath_hmax_t | decimal | average of maximum relative humidity during second trimester |
| ath_tg_t | decimal | average of mean temperature from eobs data during second trimester |
| ath_tn_t | decimal | average of minimum temperature from eobs data during second trimester |
| ath_tx_t | decimal | average of maximum temperature from eobs data during second trimester |
| ath_hu_t | decimal | average of relative humidity from eobs data during second trimester |
| ath_rr_t | decimal | average of precipitation sum from eobs data during second trimester |
| ath_qq_t | decimal | average of daily mean global radiation from eobs data during second trimester |
| ath_pp_t | decimal | average of sea level pressure from eobs data during second trimester |
| ath_uvddc_t | decimal | average of DNA-damage UV dose during second trimester |
| ath_uvdec_t | decimal | average of erythemal UV dose during second trimester |
| ath_uvdvc_t | decimal | average of vitamin-d UV dose during second trimester |
| ath_lst_t | decimal | land surface temperature during second trimester |
| ath_mdist_t | decimal | distance to meteorological station during second trimester |
...
| ath_no2e_ | decimal | no2e average value (extrapolated back in time using ratio method) during # year (># year and <=#+1 year) |
...
| ath_pm25e_ | decimal | pm25e average value (extrapolated back in time using ratio method) during # year (># year and <=#+1 year) |
...
| ath_ndvi100_ | decimal | average of NDVI values within a buffer of 100 m at # year |
| ath_ndvi300_ | decimal | average of NDVI values within a buffer of 300 m at # year |
| ath_ndvi500_ | decimal | average of NDVI values within a buffer of 500 m at # year |
