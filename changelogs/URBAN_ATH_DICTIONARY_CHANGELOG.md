...
have data with chidren moving from one are to another at different time periods. replace variable 'urb_deg_' with 'urb_deg_t' 
in trimester-repeated data dictionary.
...
- replace variable 'urb_deg_' with 'urb_deg_t' 
